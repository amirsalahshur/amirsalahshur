<div style="background: linear-gradient(135deg, #0d1117 0%, #161b22 50%, #21262d 100%); border: 2px solid #30363d; border-radius: 12px; padding: 30px; margin: 20px; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.3);" align="center">
